...
class Modeling:
    ...
    def get_similar_listings(self, listing_id, top_k=5):
        ...
        return self.sampled_data[self.sampled_data['listing_id'].isin(similar_listing_indices)][['listing_id', 'user_id']]
    ...
    def evaluate_model(self, k=5):
        ...
        print("Mean Precision@{} for all users:".format(k), mean_precision_score)
